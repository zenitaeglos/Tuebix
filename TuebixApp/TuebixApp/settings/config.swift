...
let CONFERENCES: [Conference] = [
    ...
    Conference(title: "Froscon", type: "basic", years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021], basicURL: "https://programm.froscon.de/", endURL: "/schedule.xml", imageName: "froscon-logo"),
    Conference(title: "Open South Code", type: "basic", years: [2018, 2019], basicURL: "https://www.opensouthcode.org/conferences/opensouthcode", endURL: "/schedule.xml", imageName: "osc-logo"),
